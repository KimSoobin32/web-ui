$(function () {
  ...
  //100%상태를 미리 html로.. from에 0%상태 정의
  ...
  TL.from(
    ...
    1 //전체 타임라인의 1초 지점으로 이동, 이 후에 나오는 애니메이션도 여길 기준으로 시간이 조정
  );
  TL.from('.bruce-lee', {
    autoAlpha: 0,
    scale: 1.2,
  ...
  $window.on('mousemove', (e) => {
    ...
    // 전체 화면크기1920의 절반960을 빼줌 =>정중앙 기준으로 만들기(화면 중심에 마우스 중심을 맞춤)
